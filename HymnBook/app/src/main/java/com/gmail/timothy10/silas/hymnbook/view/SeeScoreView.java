...
public class SeeScoreView extends LinearLayout {
	...
	{
		ArrayList<SSystem.BarRange> rval = new ArrayList<>();
    ...
    private float noteXPos(Note note) throws ScoreException {
	...
	private Stack<Runnable> abortStack = new Stack<Runnable>();
	...
	void colourItem(int partIndex, int barIndex, int item_h, RenderItem.Colour col, boolean single_system_colouring)
	{
		for (View view : views) {
			if (view instanceof SystemView
				&& view.isShown()) {
