...
public class SystemView extends View {
		...
		if (tn != null) {
			gestureDetector = new GestureDetector(context, new GestureDetector.OnGestureListener() {
				...
				public boolean onSingleTapUp(MotionEvent motionEvent) {
                    ...
                    try {
                        components = system.hitTest(lastTapPos);
				...
				public void onLongPress(MotionEvent motionEvent) {
                    ...
                    Component[] components = new Component[0];
                    try {
                        components = system.hitTest(new Point(motionEvent.getX(), motionEvent.getY()));
                    } catch (ScoreException e) {
                        e.printStackTrace();
                    }
	 ...
	 */
	public void colourItem(int partIndex, int barIndex, int item_h, RenderItem.Colour col)
	{
		if (item_h != 0)
		{
